...
import dev.gloriosayuu.questlogtab.QuestlogTabConfig;
...
public class TabQuestlog extends BaseTab<TabQuestlog> {
	...
	public void renderBackground(GuiGraphics g) {
		if (this.visible) {
            ...
            if (QuestlogTabConfig.useOriginalIcon.get()) {
                g.blit(new ResourceLocation(Questlog.MODID, "textures/gui/questlog_button.png"),
                        getX() + 5, getY() + 9, 120, 121, 16, 16);
            } else {
